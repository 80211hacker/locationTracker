...
const Mapper = compose(
  ...
  withStateHandlers(() => ({
    ...
    componentDidMount() {
      ...
      console.log('!!!!!!!!!!');
      console.log(this.props.originCordsArr.lat);
      console.log(this.props.originCordsArr.lng);

      // console.log(DirectionsService);

      DirectionsService.route({

        origin: new google.maps.LatLng(this.props.originCordsArr.lat, this.props.originCordsArr.lng),
